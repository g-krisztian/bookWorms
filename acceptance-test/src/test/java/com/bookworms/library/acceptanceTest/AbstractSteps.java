...
public abstract class AbstractSteps extends ApplicationContextConfiguration{
    ...
    private static MockHttpServletResponse lastGetResponse;
    private static MockHttpServletResponse lastPostResponse;
    private static MockHttpServletResponse lastPutResponse;
